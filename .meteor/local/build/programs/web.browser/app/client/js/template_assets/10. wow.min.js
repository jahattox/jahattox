...
/////////////////////////////////////////////////////////////////////////
//                                                                     //
// client/js/template_assets/10. wow.min.js                            //
//                                                                     //
/////////////////////////////////////////////////////////////////////////
                                                                       //
...
* Copyright (c) 2014 Matthieu Aussaguel; Licensed MIT */(function () {
  var a,                                                               // 2
      ...
      f = function (a, b) {                                            //
    return function () {                                               // 2
      return a.apply(b, arguments);                                    // 2
    };                                                                 //
  },                                                                   //
      g = [].indexOf || function (a) {                                 //
    for (var b = 0, c = this.length; c > b; b++) if (b in this && this[b] === a) return b;return -1;
  };b = (function () {                                                 //
    function a() {}return (a.prototype.extend = function (a, b) {      // 2
      var c, d;for (c in babelHelpers.sanitizeForInObject(b)) d = b[c], null == a[c] && (a[c] = d);return a;
    ...
    return (this.getPropertyValue = function (b) {                     // 2
    ...
    function e(a) {                                                    // 2
      ...
      return a.notSupported ? this.doSync(this.element) : void 0;      // 2
      ...
      var c, d, e;return (d = a.getAttribute("data-wow-duration"), c = a.getAttribute("data-wow-delay"), e = a.getAttribute("data-wow-iteration"), this.animate((function (f) {
        return function () {                                           // 2
          return f.customStyle(a, b, d, c, e);                         // 2
        };                                                             //
      })(this)));                                                      //
    }, e.prototype.animate = (function () {                            //
      return "requestAnimationFrame" in window ? function (a) {        // 2
        return window.requestAnimationFrame(a);                        // 2
      } : function (a) {                                               //
        return a();                                                    // 2
      };                                                               //
      ...
      var c, d, e, f;f = [];for (c in babelHelpers.sanitizeForInObject(b)) d = b[c], a["" + c] = d, f.push((function () {
      ...
      var b;try {                                                      // 2
        b = this.vendorCSS(a, "animation-name").cssText;               // 2
      } catch (c) {                                                    //
        b = d(a).getPropertyValue("animation-name");                   // 2
      }return "none" === b ? "" : b;                                   //
    }, e.prototype.cacheAnimationName = function (a) {                 //
      return this.animationNameCache.set(a, this.animationName(a));    // 2
    }, e.prototype.cachedAnimationName = function (a) {                //
      return this.animationNameCache.get(a);                           // 2
    }, e.prototype.scrollHandler = function () {                       //
      return this.scrolled = !0;                                       // 2
      ...
      return null != this._util ? this._util : this._util = new b();   // 2
