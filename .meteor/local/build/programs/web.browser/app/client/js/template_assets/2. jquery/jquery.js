...
/////////////////////////////////////////////////////////////////////////
//                                                                     //
// client/js/template_assets/2. jquery/jquery.js                       //
//                                                                     //
/////////////////////////////////////////////////////////////////////////
                                                                       //
...
!(function (a, b) {                                                    // 2
  ...
  var c = [],                                                          // 2
      ...
      l = "1.11.1",                                                    //
      m = function (a, b) {                                            //
    return new m.fn.init(a, b);                                        // 2
  },                                                                   //
      n = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,                        //
      o = /^-ms-/,                                                     //
      p = /-([\da-z])/gi,                                              //
      q = function (a, b) {                                            //
    return b.toUpperCase();                                            // 2
  };m.fn = m.prototype = { jquery: l, constructor: m, selector: "", length: 0, toArray: function () {
      return d.call(this);                                             // 2
    }, get: function (a) {                                             //
      return null != a ? 0 > a ? this[a + this.length] : this[a] : d.call(this);
    }, pushStack: function (a) {                                       //
      var b = m.merge(this.constructor(), a);return (b.prevObject = this, b.context = this.context, b);
    }, each: function (a, b) {                                         //
      return m.each(this, a, b);                                       // 2
    }, map: function (a) {                                             //
      return this.pushStack(m.map(this, function (b, c) {              // 2
        return a.call(b, c, b);                                        // 2
      }));                                                             //
    }, slice: function () {                                            //
      return this.pushStack(d.apply(this, arguments));                 // 2
    }, first: function () {                                            //
      return this.eq(0);                                               // 2
    }, last: function () {                                             //
      return this.eq(-1);                                              // 2
      ...
      return this.prevObject || this.constructor(null);                // 2
    ...
    var a,                                                             // 2
        ...
        h = 1,                                                         //
        i = arguments.length,                                          //
        j = !1;for ("boolean" == typeof g && (j = g, g = arguments[h] || {}, h++), "object" == typeof g || m.isFunction(g) || (g = {}), h === i && (g = this, h--); i > h; h++) if (null != (e = arguments[h])) for (d in babelHelpers.sanitizeForInObject(e)) a = g[d], c = e[d], g !== c && (j && c && (m.isPlainObject(c) || (b = m.isArray(c))) ? (b ? (b = !1, f = a && m.isArray(a) ? a : []) : f = a && m.isPlainObject(a) ? a : {}, g[d] = m.extend(j, f, c)) : void 0 !== c && (g[d] = c));return g;
  }, m.extend({ expando: "jQuery" + (l + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (a) {
      throw new Error(a);                                              // 2
    }, noop: function () {}, isFunction: function (a) {                //
      return "function" === m.type(a);                                 // 2
    }, isArray: Array.isArray || function (a) {                        //
      return "array" === m.type(a);                                    // 2
    }, isWindow: function (a) {                                        //
      return null != a && a == a.window;                               // 2
    }, isNumeric: function (a) {                                       //
      return !m.isArray(a) && a - parseFloat(a) >= 0;                  // 2
    }, isEmptyObject: function (a) {                                   //
      var b;for (b in babelHelpers.sanitizeForInObject(a)) return !1;return !0;
    }, isPlainObject: function (a) {                                   //
      var b;if (!a || "object" !== m.type(a) || a.nodeType || m.isWindow(a)) return !1;try {
        if (a.constructor && !j.call(a, "constructor") && !j.call(a.constructor.prototype, "isPrototypeOf")) return !1;
      } catch (c) {                                                    //
        return !1;                                                     // 2
      }if (k.ownLast) for (b in babelHelpers.sanitizeForInObject(a)) return j.call(a, b);for (b in babelHelpers.sanitizeForInObject(a));return void 0 === b || j.call(a, b);
    }, type: function (a) {                                            //
      return null == a ? a + "" : "object" == typeof a || "function" == typeof a ? h[i.call(a)] || "object" : typeof a;
    }, globalEval: function (b) {                                      //
      b && m.trim(b) && (a.execScript || function (b) {                // 2
        a.eval.call(a, b);                                             // 2
      })(b);                                                           //
    }, camelCase: function (a) {                                       //
      return a.replace(o, "ms-").replace(p, q);                        // 2
      ...
      var d,                                                           // 2
        ...
        } else for (e in babelHelpers.sanitizeForInObject(a)) if ((d = b.apply(a[e], c), d === !1)) break;
      } else if (g) {                                                  //
        for (; f > e; e++) if ((d = b.call(a[e], e, a[e]), d === !1)) break;
      } else for (e in babelHelpers.sanitizeForInObject(a)) if ((d = b.call(a[e], e, a[e]), d === !1)) break;return a;
    }, trim: function (a) {                                            //
      return null == a ? "" : (a + "").replace(n, "");                 // 2
      ...
      var d,                                                           // 2
          ...
          g = a.length,                                                //
          h = r(a),                                                    //
          i = [];if (h) for (; g > f; f++) d = b(a[f], f, c), null != d && i.push(d);else for (f in babelHelpers.sanitizeForInObject(a)) d = b(a[f], f, c), null != d && i.push(d);return e.apply([], i);
    }, guid: 1, proxy: function (a, b) {                               //
      var c, e, f;return ("string" == typeof b && (f = a[b], b = a, a = f), m.isFunction(a) ? (c = d.call(arguments, 2), e = function () {
        return a.apply(b || this, c.concat(d.call(arguments)));        // 2
      }, e.guid = a.guid = a.guid || m.guid++, e) : void 0);           //
    }, now: function () {                                              //
      return +new Date();                                              // 2
    }, support: k }), m.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function (a, b) {
    h["[object " + b + "]"] = b.toLowerCase();                         // 2
  });function r(a) {                                                   //
    var b = a.length,                                                  // 2
    ...
    var b,                                                             // 2
      ...
      I = { apply: F.length ? function (a, b) {                        // 2
          H.apply(a, J.call(b));                                       // 2
        } : function (a, b) {                                          //
          var c = a.length,                                            // 2
      ...
      var f, h, j, k, l, o, r, s, w, x;if (((b ? b.ownerDocument || b : v) !== n && m(b), b = b || n, d = d || [], !a || "string" != typeof a)) return d;if (1 !== (k = b.nodeType) && 9 !== k) return [];if (p && !e) {
        if (f = _.exec(a)) if (j = f[1]) {                             // 2
          ...
          if ((s = r = u, w = b, x = 9 === k && a, 1 === k && "object" !== b.nodeName.toLowerCase())) {
            ...
            return (I.apply(d, w.querySelectorAll(x)), d);             // 2
          } catch (y) {} finally {                                     //
            r || b.removeAttribute("id");                              // 2
          }                                                            //
        }                                                              //
      }return i(a.replace(R, "$1"), b, d, e);                          //
    }function gb() {                                                   //
      var a = [];function b(c, e) {                                    // 2
        return (a.push(c + " ") > d.cacheLength && delete b[a.shift()], b[c + " "] = e);
      }return b;                                                       //
    }function hb(a) {                                                  //
      return (a[u] = !0, a);                                           // 2
    }function ib(a) {                                                  //
      var b = n.createElement("div");try {                             // 2
        return !!a(b);                                                 // 2
      } catch (c) {                                                    //
        return !1;                                                     // 2
      } finally {                                                      //
        b.parentNode && b.parentNode.removeChild(b), b = null;         // 2
      }                                                                //
    }function jb(a, b) {                                               //
      var c = a.split("|"),                                            // 2
      ...
      return hb(function (b) {                                         // 2
        return (b = +b, hb(function (c, d) {                           // 2
          var e,                                                       // 2
              f = a([], c.length, b),                                  //
      ...
      return a && typeof a.getElementsByTagName !== C && a;            // 2
      ...
      var b,                                                           // 2
        ...
        return (a.className = "i", !a.getAttribute("className"));      // 2
        ...
        if (typeof b.getElementById !== C && p) {                      // 2
          var c = b.getElementById(a);return c && c.parentNode ? [c] : [];
        }                                                              //
      }, d.filter.ID = function (a) {                                  //
        var b = a.replace(cb, db);return function (a) {                // 2
        ...
        var c,                                                         // 2
          ...
          while (c = f[e++]) 1 === c.nodeType && d.push(c);return d;   // 2
        }return f;                                                     //
        ...
        var c = 9 === a.nodeType ? a.documentElement : a,              // 2
      ...
      throw new Error("Syntax error, unrecognized expression: " + a);  // 2
      ...
      var b,                                                           // 2
        ...
        if (1 === f || 9 === f || 11 === f) {                          // 2
          ...
          var b = a.replace(cb, db).toLowerCase();return "*" === a ? function () {
            ...
            return a.nodeName && a.nodeName.toLowerCase() === b;       // 2
          };                                                           //
        }, CLASS: function (a) {                                       //
          ...
          var f = "nth" !== a.slice(0, 3),                             // 2
              g = "last" !== a.slice(-4),                              //
              h = "of-type" === b;return 1 === d && 0 === e ? function (a) {
            return !!a.parentNode;                                     // 2
          } : function (b, c, i) {                                     //
            var j,                                                     // 2
                k,                                                     //
                l,                                                     //
          ...
          var b = [],                                                  // 2
            ...
            return (b[0] = a, d(b, null, f, c), !c.pop());             // 2
          };                                                           //
        }), has: hb(function (a) {                                     //
          return function (b) {                                        // 2
            return fb(a, b).length > 0;                                // 2
          };                                                           //
          ...
          return a.disabled === !1;                                    // 2
        }, disabled: function (a) {                                    //
          return a.disabled === !0;                                    // 2
        }, checked: function (a) {                                     //
          ...
          return !d.pseudos.empty(a);                                  // 2
        }, header: function (a) {                                      //
          return Z.test(a.nodeName);                                   // 2
        }, input: function (a) {                                       //
          return Y.test(a.nodeName);                                   // 2
        }, button: function (a) {                                      //
          ...
          for (var c = 0; b > c; c += 2) a.push(c);return a;           // 2
        }), odd: nb(function (a, b) {                                  //
          for (var c = 1; b > c; c += 2) a.push(c);return a;           // 2
        }), lt: nb(function (a, b, c) {                                //
          for (var d = 0 > c ? c + b : c; --d >= 0;) a.push(d);return a;
        }), gt: nb(function (a, b, c) {                                //
          for (var d = 0 > c ? c + b : c; ++d < b;) a.push(d);return a;
        }) } }, d.pseudos.nth = d.pseudos.eq;for (b in babelHelpers.sanitizeForInObject({ radio: !0, checkbox: !0, file: !0, password: !0, image: !0 })) d.pseudos[b] = lb(b);for (b in babelHelpers.sanitizeForInObject({ submit: !0, reset: !0 })) d.pseudos[b] = mb(b);function pb() {}pb.prototype = d.filters = d.pseudos, d.setFilters = new pb(), g = fb.tokenize = function (a, b) {
      var c,                                                           // 2
          e,                                                           //
          f,                                                           //
          g,                                                           //
        ...
        (!c || (e = S.exec(h))) && (e && (h = h.slice(e[0].length) || h), i.push(f = [])), c = !1, (e = T.exec(h)) && (c = e.shift(), f.push({ value: c, type: e[0].replace(R, " ") }), h = h.slice(c.length));for (g in babelHelpers.sanitizeForInObject(d.filter)) !(e = X[g].exec(h)) || j[g] && !(e = j[g](e)) || (c = e.shift(), f.push({ value: c, type: g, matches: e }), h = h.slice(c.length));if (!c) break;
      ...
      return a.length > 1 ? function (b, c, d) {                       // 2
      ...
      var c = b.length > 0,                                            // 2
        ...
        var l,                                                         // 2
          ...
          if (e && l) {                                                // 2
            m = 0;while (o = a[m++]) if (o(l, g, h)) {                 // 2
              i.push(l);break;                                         // 2
            }k && (w = v);                                             //
          }c && ((l = !o && l) && p--, f && r.push(l));                //
        }if ((p += q, c && q !== p)) {                                 //
          m = 0;while (o = b[m++]) o(r, s, g, h);if (f) {              // 2
      ...
      return 1 & a.compareDocumentPosition(n.createElement("div"));    // 2
    }), ib(function (a) {                                              //
      ...
      return null == a.getAttribute("disabled");                       // 2
    }) || jb(L, function (a, b, c) {                                   //
      ...
      u = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,                                //
      v = /^.[^:#\[\.,]*$/;function w(a, b, c) {                       //
    if (m.isFunction(b)) return m.grep(a, function (a, d) {            // 2
      return !!b.call(a, d, a) !== c;                                  // 2
    });if (b.nodeType) return m.grep(a, function (a) {                 //
      return a === b !== c;                                            // 2
    });if ("string" == typeof b) {                                     //
      if (v.test(b)) return m.filter(b, a, c);b = m.filter(b, a);      // 2
    }return m.grep(a, function (a) {                                   //
      return m.inArray(a, b) >= 0 !== c;                               // 2
    });                                                                //
  }m.filter = function (a, b, c) {                                     //
    var d = b[0];return (c && (a = ":not(" + a + ")"), 1 === b.length && 1 === d.nodeType ? m.find.matchesSelector(d, a) ? [d] : [] : m.find.matches(a, m.grep(b, function (a) {
      return 1 === a.nodeType;                                         // 2
    })));                                                              //
      ...
      return this.pushStack(w(this, a || [], !1));                     // 2
    }, not: function (a) {                                             //
      return this.pushStack(w(this, a || [], !0));                     // 2
    }, is: function (a) {                                              //
    ...
    var c, d;if (!a) return this;if ("string" == typeof a) {           // 2
      if ((c = "<" === a.charAt(0) && ">" === a.charAt(a.length - 1) && a.length >= 3 ? [null, a, null] : z.exec(a), !c || !c[1] && b)) return !b || b.jquery ? (b || x).find(a) : this.constructor(b).find(a);if (c[1]) {
        if ((b = b instanceof m ? b[0] : b, m.merge(this, m.parseHTML(c[1], b && b.nodeType ? b.ownerDocument || b : y, !0)), u.test(c[1]) && m.isPlainObject(b))) for (c in babelHelpers.sanitizeForInObject(b)) m.isFunction(this[c]) ? this[c](b[c]) : this.attr(c, b[c]);return this;
      ...
      return this.pushStack(m.unique(m.merge(this.get(), m(a, b))));   // 2
    }, addBack: function (a) {                                         //
      return this.add(null == a ? this.prevObject : this.prevObject.filter(a));
    } });function D(a, b) {                                            //
    do a = a[b]; while (a && 1 !== a.nodeType);return a;               // 2
  }m.each({ parent: function (a) {                                     //
      var b = a.parentNode;return b && 11 !== b.nodeType ? b : null;   // 2
    }, parents: function (a) {                                         //
      return m.dir(a, "parentNode");                                   // 2
    }, parentsUntil: function (a, b, c) {                              //
      return m.dir(a, "parentNode", c);                                // 2
    }, next: function (a) {                                            //
      return D(a, "nextSibling");                                      // 2
    }, prev: function (a) {                                            //
      return D(a, "previousSibling");                                  // 2
    }, nextAll: function (a) {                                         //
      return m.dir(a, "nextSibling");                                  // 2
    }, prevAll: function (a) {                                         //
      return m.dir(a, "previousSibling");                              // 2
    }, nextUntil: function (a, b, c) {                                 //
      return m.dir(a, "nextSibling", c);                               // 2
    }, prevUntil: function (a, b, c) {                                 //
      return m.dir(a, "previousSibling", c);                           // 2
    }, siblings: function (a) {                                        //
      return m.sibling((a.parentNode || {}).firstChild, a);            // 2
    }, children: function (a) {                                        //
      return m.sibling(a.firstChild);                                  // 2
    }, contents: function (a) {                                        //
      return m.nodeName(a, "iframe") ? a.contentDocument || a.contentWindow.document : m.merge([], a.childNodes);
    } }, function (a, b) {                                             //
    m.fn[a] = function (c, d) {                                        // 2
    ...
    a = "string" == typeof a ? F[a] || G(a) : m.extend({}, a);var b,   // 2
        c,                                                             //
        d,                                                             //
        e,                                                             //
        f,                                                             //
      ...
      for (c = a.memory && l, d = !0, f = g || 0, g = 0, e = h.length, b = !0; h && e > f; f++) if (h[f].apply(l[0], l[1]) === !1 && a.stopOnFalse) {
        ...
        k = { add: function () {                                       //
        if (h) {                                                       // 2
          var d = h.length;!(function () {                             // 2
            function f(b) {                                            // 2
              m.each(b, function (b, c) {                              // 2
        ...
        return (h && m.each(arguments, function (a, c) {               // 2
          var d;while ((d = m.inArray(c, h, d)) > -1) h.splice(d, 1), b && (e >= d && e--, f >= d && f--);
        }), this);                                                     //
      }, has: function (a) {                                           //
        return a ? m.inArray(a, h) > -1 : !(!h || !h.length);          // 2
      }, empty: function () {                                          //
        return (h = [], e = 0, this);                                  // 2
      }, disable: function () {                                        //
        return (h = i = c = void 0, this);                             // 2
      }, disabled: function () {                                       //
        return !h;                                                     // 2
      }, lock: function () {                                           //
        return (i = void 0, c || k.disable(), this);                   // 2
      }, locked: function () {                                         //
        return !i;                                                     // 2
      }, fireWith: function (a, c) {                                   //
        return (!h || d && !i || (c = c || [], c = [a, c.slice ? c.slice() : c], b ? i.push(c) : j(c)), this);
      }, fire: function () {                                           //
        return (k.fireWith(this, arguments), this);                    // 2
      }, fired: function () {                                          //
        return !!d;                                                    // 2
      } };return k;                                                    //
      ...
      var b = [["resolve", "done", m.Callbacks("once memory"), "resolved"], ["reject", "fail", m.Callbacks("once memory"), "rejected"], ["notify", "progress", m.Callbacks("memory")]],
          ...
          return (e.done(arguments).fail(arguments), this);            // 2
        }, then: function () {                                         //
          var a = arguments;return m.Deferred(function (c) {           // 2
            m.each(b, function (b, f) {                                // 2
          ...
          return null != a ? m.extend(a, d) : d;                       // 2
        } },                                                           //
    ...
    return (m.ready.promise().done(a), this);                          // 2
  }, m.extend({ isReady: !1, readyWait: 1, holdReady: function (a) {   //
      a ? m.readyWait++ : m.ready(!0);                                 // 2
    }, ready: function (a) {                                           //
      if (a === !0 ? ! --m.readyWait : !m.isReady) {                   // 2
    ...
    if (!H) if ((H = m.Deferred(), "complete" === y.readyState)) setTimeout(m.ready);else if (y.addEventListener) y.addEventListener("DOMContentLoaded", J, !1), a.addEventListener("load", J, !1);else {
      y.attachEvent("onreadystatechange", J), a.attachEvent("onload", J);var c = !1;try {
        c = null == a.frameElement && y.documentElement;               // 2
      } catch (d) {}c && c.doScroll && !(function () {                 //
        function e() {                                                 // 2
          if (!m.isReady) {                                            // 2
            try {                                                      // 2
              c.doScroll("left");                                      // 2
            } catch (a) {                                              //
              return setTimeout(e, 50);                                // 2
            }I(), m.ready();                                           //
          }                                                            //
        }                                                              //
                                                                       //
      ...
      L;for (L in babelHelpers.sanitizeForInObject(m(k))) break;k.ownLast = "0" !== L, k.inlineBlockNeedsLayout = !1, m(function () {
    var a, b, c, d;c = y.getElementsByTagName("body")[0], c && c.style && (b = y.createElement("div"), d = y.createElement("div"), d.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", c.appendChild(d).appendChild(b), typeof b.style.zoom !== K && (b.style.cssText = "display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1", k.inlineBlockNeedsLayout = a = 3 === b.offsetWidth, a && (c.style.zoom = 1)), c.removeChild(d));
  }), (function () {                                                   //
    var a = y.createElement("div");if (null == k.deleteExpando) {      // 2
      k.deleteExpando = !0;try {                                       // 2
        delete a.test;                                                 // 2
      } catch (b) {                                                    //
        k.deleteExpando = !1;                                          // 2
      }                                                                //
    ...
    var b = m.noData[(a.nodeName + " ").toLowerCase()],                // 2
        c = +a.nodeType || 1;return 1 !== c && 9 !== c ? !1 : !b || b !== !0 && a.getAttribute("classid") === b;
  };var M = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,                           //
      N = /([A-Z])/g;function O(a, b, c) {                             //
    if (void 0 === c && 1 === a.nodeType) {                            // 2
    ...
    var b;for (b in babelHelpers.sanitizeForInObject(a)) if (("data" !== b || !m.isEmptyObject(a[b])) && "toJSON" !== b) return !1;return !0;
  }function Q(a, b, d, e) {                                            //
    if (m.acceptData(a)) {                                             // 2
      var f,                                                           // 2
          g,                                                           //
    ...
    if (m.acceptData(a)) {                                             // 3
      ...
      var c = b + "queueHooks";return m._data(a, c) || m._data(a, c, { empty: m.Callbacks("once memory").add(function () {
          m._removeData(a, b + "queue"), m._removeData(a, c);          // 3
        }) });                                                         //
    ...
    var h = 0,                                                         // 3
      ...
      e = !0;for (h in babelHelpers.sanitizeForInObject(c)) m.access(a, b, h, c[h], !0, f, g);
    } else if (void 0 !== d && (e = !0, m.isFunction(d) || (g = !0), j && (g ? (b.call(a, d), b = null) : (j = b, b = function (a, b, c) {
      return j.call(m(a), c);                                          // 3
    })), b)) for (; i > h; h++) b(a[h], c, g ? d : d.call(a[h], h, b(a[h], c)));return e ? a : j ? b.call(a) : i ? b(a[0], c) : f;
  },                                                                   //
      W = /^(?:checkbox|radio)$/i;!(function () {                      //
    var a = y.createElement("input"),                                  // 3
    ...
    var b,                                                             // 3
        c,                                                             //
        d = y.createElement("div");for (b in babelHelpers.sanitizeForInObject({ submit: !0, change: !0, focusin: !0 })) c = "on" + b, (k[b + "Bubbles"] = c in a) || (d.setAttribute(c, "t"), k[b + "Bubbles"] = d.attributes[c].expando === !1);d = null;
    ...
    try {                                                              // 3
      ...
      var f,                                                           // 3
        ...
        } else for (o in babelHelpers.sanitizeForInObject(k)) m.event.remove(a, o + b[j], c, d, !0);m.isEmptyObject(k) && (delete r.handle, m._removeData(a, "events"));
      }                                                                //
      ...
      var f,                                                           // 3
        ...
        if (!e && !k.noBubble && !m.isWindow(d)) {                     // 3
          ...
          l = d[g], l && (d[g] = null), m.event.triggered = p;try {    // 3
            d[p]();                                                    // 3
          } catch (r) {}m.event.triggered = void 0, l && (d[g] = l);   //
        }return b.result;                                              //
      }                                                                //
    }, dispatch: function (a) {                                        //
      a = m.event.fix(a);var b,                                        // 3
          c,                                                           //
          e,                                                           //
          f,                                                           //
          g,                                                           //
      ...
      if (a[m.expando]) return a;var b,                                // 3
          c,                                                           //
          d,                                                           //
          e = a.type,                                                  //
          f = a,                                                       //
        ...
        var c,                                                         // 3
          ...
          if (this !== cb() && this.focus) try {                       // 3
            return (this.focus(), !1);                                 // 3
          } catch (a) {}                                               //
          ...
          return m.nodeName(a.target, "a");                            // 3
        } }, beforeunload: { postDispatch: function (a) {              //
          void 0 !== a.result && a.originalEvent && (a.originalEvent.returnValue = a.result);
        } } }, simulate: function (a, b, c, d) {                       //
      var e = m.extend(new m.Event(), c, { type: a, isSimulated: !0, originalEvent: {} });d ? m.event.trigger(e, null, b) : m.event.dispatch.call(b, e), e.isDefaultPrevented() && c.preventDefault();
    } }, m.removeEvent = y.removeEventListener ? function (a, b, c) {  //
    a.removeEventListener && a.removeEventListener(b, c, !1);          // 3
  } : function (a, b, c) {                                             //
    ...
    var c = function (a) {                                             // 3
      m.event.simulate(b, a.target, m.event.fix(a), !0);               // 3
    };m.event.special[b] = { setup: function () {                      //
        var d = this.ownerDocument || this,                            // 3
      ...
      var f, g;if ("object" == typeof a) {                             // 3
        "string" != typeof b && (c = c || b, b = void 0);for (f in babelHelpers.sanitizeForInObject(a)) this.on(f, b, c, a[f], e);return this;
        ...
        return (m().off(a), g.apply(this, arguments));                 // 3
      }, d.guid = g.guid || (g.guid = m.guid++)), this.each(function () {
        m.event.add(this, a, d, c, b);                                 // 3
      }));                                                             //
    }, one: function (a, b, c, d) {                                    //
      return this.on(a, b, c, d, 1);                                   // 3
    }, off: function (a, b, c) {                                       //
      var d, e;if (a && a.preventDefault && a.handleObj) return (d = a.handleObj, m(a.delegateTarget).off(d.namespace ? d.origType + "." + d.namespace : d.origType, d.selector, d.handler), this);if ("object" == typeof a) {
        for (e in babelHelpers.sanitizeForInObject(a)) this.off(e, b, a[e]);return this;
      }return ((b === !1 || "function" == typeof b) && (c = b, b = void 0), c === !1 && (c = bb), this.each(function () {
        m.event.remove(this, a, c, b);                                 // 3
      }));                                                             //
    }, trigger: function (a, b) {                                      //
      return this.each(function () {                                   // 3
        m.event.trigger(a, b, this);                                   // 3
      });                                                              //
    ...
    W.test(a.type) && (a.defaultChecked = a.checked);                  // 3
  }function wb(a, b) {                                                 //
    ...
    if (1 === b.nodeType && m.hasData(a)) {                            // 3
      var c,                                                           // 3
          ...
          g = m._data(b, f),                                           //
          h = f.events;if (h) {                                        //
        delete g.handle, g.events = {};for (c in babelHelpers.sanitizeForInObject(h)) for (d = 0, e = h[c].length; e > d; d++) m.event.add(b, c, h[c][d]);
      }g.data && (g.data = m.extend({}, g.data));                      //
    }                                                                  //
  }function Bb(a, b) {                                                 //
    var c, d, e;if (1 === b.nodeType) {                                // 3
      if ((c = b.nodeName.toLowerCase(), !k.noCloneEvent && b[m.expando])) {
        e = m._data(b);for (d in babelHelpers.sanitizeForInObject(e.events)) m.removeEvent(b, d, e.handle);b.removeAttribute(m.expando);
      ...
      for (var e, f, g, h, i, j, l, n = a.length, o = db(b), p = [], q = 0; n > q; q++) if ((f = a[q], f || 0 === f)) if ("object" === m.type(f)) m.merge(p, f.nodeType ? [f] : f);else if (lb.test(f)) {
        ...
        e = 0;while (f = h[e++]) ob.test(f.type || "") && c.push(f);   // 3
      }return (h = null, o);                                           //
    }, cleanData: function (a, b) {                                    //
      for (var d, e, f, g, h = 0, i = m.expando, j = m.cache, l = k.deleteExpando, n = m.event.special; null != (d = a[h]); h++) if ((b || m.acceptData(d)) && (f = d[i], g = f && j[f])) {
        if (g.events) for (e in babelHelpers.sanitizeForInObject(g.events)) n[e] ? m.event.remove(d, e) : m.removeEvent(d, e, g.handle);j[f] && (delete j[f], l ? delete d[i] : typeof d.removeAttribute !== K ? d.removeAttribute(i) : d[i] = null, c.push(f));
      }                                                                //
    } }), m.fn.extend({ text: function (a) {                           //
      return V(this, function (a) {                                    // 3
        return void 0 === a ? m.text(this) : this.empty().append((this[0] && this[0].ownerDocument || y).createTextNode(a));
      }, null, a, arguments.length);                                   //
    }, append: function () {                                           //
      return this.domManip(arguments, function (a) {                   // 3
        if (1 === this.nodeType || 11 === this.nodeType || 9 === this.nodeType) {
          var b = wb(this, a);b.appendChild(a);                        // 3
        }                                                              //
      });                                                              //
    }, prepend: function () {                                          //
      return this.domManip(arguments, function (a) {                   // 3
        if (1 === this.nodeType || 11 === this.nodeType || 9 === this.nodeType) {
          var b = wb(this, a);b.insertBefore(a, b.firstChild);         // 3
        }                                                              //
      });                                                              //
    }, before: function () {                                           //
      return this.domManip(arguments, function (a) {                   // 3
        this.parentNode && this.parentNode.insertBefore(a, this);      // 3
      });                                                              //
    }, after: function () {                                            //
      return this.domManip(arguments, function (a) {                   // 3
      ...
      for (var a, b = 0; null != (a = this[b]); b++) {                 // 3
    ...
    var a;k.shrinkWrapBlocks = function () {                           // 3
    ...
    return a.ownerDocument.defaultView.getComputedStyle(a, null);      // 3
  }, Jb = function (a, b, c) {                                         //
    var d,                                                             // 3
        e,                                                             //
        f,                                                             //
    ...
    var e,                                                             // 3
        f,                                                             //
        g = {};for (f in babelHelpers.sanitizeForInObject(b)) g[f] = a.style[f], a.style[f] = b[f];e = c.apply(a, d || []);for (f in babelHelpers.sanitizeForInObject(b)) a.style[f] = g[f];return e;
  };var Mb = /alpha\([^)]*\)/i,                                        //
      Nb = /opacity\s*=\s*([^)]*)/,                                    //
      Ob = /^(none|table(?!-c[ea]).+)/,                                //
      Pb = new RegExp("^(" + S + ")(.*)$", "i"),                       //
    ...
    var d = !0,                                                        // 3
      ...
      if ((e = Jb(a, b, f), (0 > e || null == e) && (e = a.style[b]), Hb.test(e))) return e;d = g && (k.boxSizingReliable() || e === a.style[b]), e = parseFloat(e) || 0;
          ...
          if (b) {                                                     // 3
            var c = Jb(a, "opacity");return "" === c ? "1" : c;        // 3
          }                                                            //
      ...
      if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {      // 3
        var e,                                                         // 3
            f,                                                         //
            g,                                                         //
            h = m.camelCase(b),                                        //
    ...
    m.cssHooks[b] = { get: function (a, c, d) {                        // 3
    ...
    m.cssHooks[a + b] = { expand: function (c) {                       // 3
      ...
      return "boolean" == typeof a ? a ? this.show() : this.hide() : this.each(function () {
        U(this) ? m(this).show() : m(this).hide();                     // 3
      });                                                              //
    } });function Zb(a, b, c, d, e) {                                  //
    return new Zb.prototype.init(a, b, c, d, e);                       // 3
      ...
      return .5 - Math.cos(a * Math.PI) / 2;                           // 4
    ...
    var d,                                                             // 4
      ...
      n.always(function () {                                           // 4
        h.unqueued--, m.queue(a, "fx").length || h.empty.fire();       // 4
      });                                                              //
    })), 1 === a.nodeType && ("height" in b || "width" in b) && (c.overflow = [p.overflow, p.overflowX, p.overflowY], j = m.css(a, "display"), l = "none" === j ? m._data(a, "olddisplay") || Fb(a.nodeName) : j, "inline" === l && "none" === m.css(a, "float") && (k.inlineBlockNeedsLayout && "inline" !== Fb(a.nodeName) ? p.zoom = 1 : p.display = "inline-block")), c.overflow && (p.overflow = "hidden", k.shrinkWrapBlocks() || n.always(function () {
      p.overflow = c.overflow[0], p.overflowX = c.overflow[1], p.overflowY = c.overflow[2];
    }));for (d in babelHelpers.sanitizeForInObject(b)) if ((e = b[d], ac.exec(e))) {
      if ((delete b[d], f = f || "toggle" === e, e === (q ? "hide" : "show"))) {
        if ("show" !== e || !r || void 0 === r[d]) continue;q = !0;    // 4
      }o[d] = r && r[d] || m.style(a, d);                              //
    } else j = void 0;if (m.isEmptyObject(o)) "inline" === ("none" === j ? Fb(a.nodeName) : j) && (p.display = j);else {
      r ? "hidden" in r && (q = r.hidden) : r = m._data(a, "fxshow", {}), f && (r.hidden = !q), q ? m(a).show() : n.done(function () {
        m(a).hide();                                                   // 4
      }), n.done(function () {                                         //
        var b;m._removeData(a, "fxshow");for (b in babelHelpers.sanitizeForInObject(o)) m.style(a, b, o[b]);
      });for (d in babelHelpers.sanitizeForInObject(o)) g = hc(q ? r[d] : 0, d, n), d in r || (r[d] = g.start, q && (g.end = g.start, g.start = "width" === d || "height" === d ? 1 : 0));
    }                                                                  //
  }function jc(a, b) {                                                 //
    var c, d, e, f, g;for (c in babelHelpers.sanitizeForInObject(a)) if ((d = m.camelCase(c), e = b[d], f = a[c], m.isArray(f) && (e = f[1], f = a[c] = f[0]), c !== d && (a[d] = f, delete a[c]), g = m.cssHooks[d], g && "expand" in g)) {
      f = g.expand(f), delete a[d];for (c in babelHelpers.sanitizeForInObject(f)) c in a || (a[c] = f[c], b[c] = e);
    } else b[d] = e;                                                   //
  }function kc(a, b, c) {                                              //
    var d,                                                             // 4
        e,                                                             //
    ...
    var d = a && "object" == typeof a ? m.extend({}, a) : { complete: c || !c && b || m.isFunction(a) && a, duration: a, easing: c && b || b && !m.isFunction(b) && b };return (d.duration = m.fx.off ? 0 : "number" == typeof d.duration ? d.duration : d.duration in m.fx.speeds ? m.fx.speeds[d.duration] : m.fx.speeds._default, (null == d.queue || d.queue === !0) && (d.queue = "fx"), d.old = d.complete, d.complete = function () {
      ...
      var d = function (a) {                                           // 4
        var b = a.stop;delete a.stop, b(c);                            // 4
      };return ("string" != typeof a && (c = b, b = a, a = void 0), b && a !== !1 && this.queue(a || "fx", []), this.each(function () {
        var b = !0,                                                    // 4
            e = null != a && a + "queueHooks",                         //
            f = m.timers,                                              //
            g = m._data(this);if (e) g[e] && g[e].stop && d(g[e]);else for (e in babelHelpers.sanitizeForInObject(g)) g[e] && g[e].stop && cc.test(e) && d(g[e]);for (e = f.length; e--;) f[e].elem !== this || null != a && f[e].queue !== a || (f[e].anim.stop(c), b = !1, f.splice(e, 1));(b || !c) && m.dequeue(this, a);
      }));                                                             //
    }, finish: function (a) {                                          //
      return (a !== !1 && (a = a || "fx"), this.each(function () {     // 4
        var b,                                                         // 4
            c = m._data(this),                                         //
            d = c[a + "queue"],                                        //
            e = c[a + "queueHooks"],                                   //
    ...
    var c = m.fn[b];m.fn[b] = function (a, d, e) {                     // 4
      return null == a || "boolean" == typeof a ? c.apply(this, arguments) : this.animate(gc(b, !0), a, d, e);
    };                                                                 //
  }), m.each({ slideDown: gc("show"), slideUp: gc("hide"), slideToggle: gc("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (a, b) {
    m.fn[a] = function (a, c, d) {                                     // 4
      return this.animate(b, a, c, d);                                 // 4
    };                                                                 //
    ...
    m.timers.push(a), a() ? m.fx.start() : m.timers.pop();             // 4
  }, m.fx.interval = 13, m.fx.start = function () {                    //
    _b || (_b = setInterval(m.fx.tick, m.fx.interval));                // 4
  }, m.fx.stop = function () {                                         //
    clearInterval(_b), _b = null;                                      // 4
  }, m.fx.speeds = { slow: 600, fast: 200, _default: 400 }, m.fn.delay = function (a, b) {
    return (a = m.fx ? m.fx.speeds[a] || a : a, b = b || "fx", this.queue(b, function (b, c) {
      var d = setTimeout(b, a);c.stop = function () {                  // 4
        clearTimeout(d);                                               // 4
      };                                                               //
    }));                                                               //
  }, (function () {                                                    //
      ...
      var b,                                                           // 4
        ...
        if (arguments.length) return (d = m.isFunction(a), this.each(function (c) {
          ...
          for (var b, c, d = a.options, e = a.selectedIndex, f = "select-one" === a.type || 0 > e, g = f ? null : [], h = f ? e + 1 : d.length, i = 0 > e ? h : f ? e : 0; h > i; i++) if ((c = d[i], !(!c.selected && i !== e || (k.optDisabled ? c.disabled : null !== c.getAttribute("disabled")) || c.parentNode.disabled && m.nodeName(c.parentNode, "optgroup")))) {
            if ((b = m(c).val(), f)) return b;g.push(b);               // 4
          }return g;                                                   //
        }, set: function (a, b) {                                      //
          var c,                                                       // 4
              d,                                                       //
    ...
    m.valHooks[this] = { set: function (a, b) {                        // 4
        return m.isArray(b) ? a.checked = m.inArray(m(a).val(), b) >= 0 : void 0;
      } }, k.checkOn || (m.valHooks[this].get = function (a) {         //
      return null === a.getAttribute("value") ? "on" : a.value;        // 4
    });                                                                //
  });var mc,                                                           //
      nc,                                                              //
      ...
      return V(this, m.attr, a, b, arguments.length > 1);              // 4
    }, removeAttr: function (a) {                                      //
      return this.each(function () {                                   // 4
        m.removeAttr(this, a);                                         // 4
      });                                                              //
    ...
    m.attrHooks[b] = { set: function (a, c) {                          // 4
        return "" === c ? (a.setAttribute(b, "auto"), c) : void 0;     // 4
      } };                                                             //
  })), k.style || (m.attrHooks.style = { get: function (a) {           //
      return a.style.cssText || void 0;                                // 4
    }, set: function (a, b) {                                          //
      return a.style.cssText = b + "";                                 // 4
    } });var sc = /^(?:input|select|textarea|button|object)$/i,        //
      tc = /^(?:a|area)$/i;m.fn.extend({ prop: function (a, b) {       //
      return V(this, m.prop, a, b, arguments.length > 1);              // 4
    }, removeProp: function (a) {                                      //
      return (a = m.propFix[a] || a, this.each(function () {           // 4
        try {                                                          // 4
          this[a] = void 0, delete this[a];                            // 4
        } catch (b) {}                                                 //
      }));                                                             //
    ...
    m.propHooks[b] = { get: function (a) {                             // 4
        return a.getAttribute(b, 4);                                   // 4
      } };                                                             //
  }), k.optSelected || (m.propHooks.selected = { get: function (a) {   //
      var b = a.parentNode;return (b && (b.selectedIndex, b.parentNode && b.parentNode.selectedIndex), null);
    } }), m.each(["tabIndex", "readOnly", "maxLength", "cellSpacing", "cellPadding", "rowSpan", "colSpan", "useMap", "frameBorder", "contentEditable"], function () {
    m.propFix[this.toLowerCase()] = this;                              // 4
      ...
      var b,                                                           // 4
        ...
        m(this).addClass(a.call(this, b, this.className));             // 4
      ...
      var b,                                                           // 4
        ...
        m(this).removeClass(a.call(this, b, this.className));          // 4
      });if (j) for (b = (a || "").match(E) || []; i > h; h++) if ((c = this[h], d = 1 === c.nodeType && (c.className ? (" " + c.className + " ").replace(uc, " ") : ""))) {
      ...
      var c = typeof a;return "boolean" == typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : this.each(m.isFunction(a) ? function (c) {
        m(this).toggleClass(a.call(this, c, this.className, b), b);    // 4
      } : function () {                                                //
        if ("string" === c) {                                          // 4
          var b,                                                       // 4
              d = 0,                                                   //
    ...
    m.fn[b] = function (a, c) {                                        // 4
      return arguments.length > 0 ? this.on(b, null, a, c) : this.trigger(b);
    };                                                                 //
  }), m.fn.extend({ hover: function (a, b) {                           //
      return this.mouseenter(a).mouseleave(b || a);                    // 4
    }, bind: function (a, b, c) {                                      //
      return this.on(a, null, b, c);                                   // 4
    }, unbind: function (a, b) {                                       //
      return this.off(a, null, b);                                     // 4
    }, delegate: function (a, b, c, d) {                               //
      return this.on(b, a, c, d);                                      // 4
    }, undelegate: function (a, b, c) {                                //
      return 1 === arguments.length ? this.off(a, "**") : this.off(b, a || "**", c);
    } });var vc = m.now(),                                             //
      wc = /\?/,                                                       //
      xc = /(,)|(\[|{)|(}|])|"(?:[^"\\\r\n]|\\["\\\/bfnrt]|\\u[\da-fA-F]{4})*"\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g;m.parseJSON = function (b) {
    if (a.JSON && a.JSON.parse) return a.JSON.parse(b + "");var c,     // 4
        d = null,                                                      //
        e = m.trim(b + "");return e && !m.trim(e.replace(xc, function (a, b, e, f) {
      return (c && b && (d = 0), 0 === d ? a : (c = e || b, d += !f - !e, ""));
    })) ? Function("return " + e)() : m.error("Invalid JSON: " + b);   //
  }, m.parseXML = function (b) {                                       //
    var c, d;if (!b || "string" != typeof b) return null;try {         // 4
    ...
    zc = y.createElement("a"), zc.href = "", zc = zc.href;             // 4
  }yc = Gc.exec(zc.toLowerCase()) || [];function Lc(a) {               //
    return function (b, c) {                                           // 4
      "string" != typeof b && (c = b, b = "*");var d,                  // 4
          e = 0,                                                       //
    ...
    var e = {},                                                        // 4
        f = a === Ic;function g(h) {                                   //
      var i;return (e[h] = !0, m.each(a[h] || [], function (a, h) {    // 4
    ...
    var c,                                                             // 4
        d,                                                             //
        e = m.ajaxSettings.flatOptions || {};for (d in babelHelpers.sanitizeForInObject(b)) void 0 !== b[d] && ((e[d] ? a : c || (c = {}))[d] = b[d]);return (c && m.extend(!0, a, c), a);
  }function Oc(a, b, c) {                                              //
    var d,                                                             // 4
        e,                                                             //
        f,                                                             //
        g,                                                             //
        h = a.contents,                                                //
        i = a.dataTypes;while ("*" === i[0]) i.shift(), void 0 === e && (e = a.mimeType || b.getResponseHeader("Content-Type"));if (e) for (g in babelHelpers.sanitizeForInObject(h)) if (h[g] && h[g].test(e)) {
      i.unshift(g);break;                                              // 4
    }if (i[0] in c) f = i[0];else {                                    //
      for (g in babelHelpers.sanitizeForInObject(c)) {                 // 4
        if (!i[0] || a.converters[g + " " + i[0]]) {                   // 4
          f = g;break;                                                 // 4
        }d || (d = g);                                                 //
      }f = f || d;                                                     //
    ...
    var e,                                                             // 4
        ...
        i,                                                             //
        j = {},                                                        //
        k = a.dataTypes.slice();if (k[1]) for (g in babelHelpers.sanitizeForInObject(a.converters)) j[g.toLowerCase()] = a.converters[g];f = k.shift();while (f) if ((a.responseFields[f] && (c[a.responseFields[f]] = b), !i && d && a.dataFilter && (b = a.dataFilter(b, a.dataType)), i = f, f = k.shift())) if ("*" === f) f = i;else if ("*" !== i && i !== f) {
      if ((g = j[i + " " + f] || j["* " + f], !g)) for (e in babelHelpers.sanitizeForInObject(j)) if ((h = e.split(" "), h[1] === f && (g = j[i + " " + h[0]] || j["* " + h[0]]))) {
      ...
      "object" == typeof a && (b = a, a = void 0), b = b || {};var c,  // 4
          d,                                                           //
          e,                                                           //
          f,                                                           //
          g,                                                           //
          ...
          return (t || (k.mimeType = a), this);                        // 4
        }, statusCode: function (a) {                                  //
          var b;if (a) if (2 > t) for (b in babelHelpers.sanitizeForInObject(a)) q[b] = [q[b], a[b]];else v.always(a[v.status]);return this;
        }, abort: function (a) {                                       //
          var b = a || u;return (i && i.abort(b), x(0, b), this);      // 4
        } };if ((o.promise(v).complete = p.add, v.success = v.done, v.error = v.fail, k.url = ((a || k.url || zc) + "").replace(Ac, "").replace(Fc, yc[1] + "//"), k.type = b.method || b.type || k.method || k.type, k.dataTypes = m.trim(k.dataType || "*").toLowerCase().match(E) || [""], null == k.crossDomain && (c = Gc.exec(k.url.toLowerCase()), k.crossDomain = !(!c || c[1] === yc[1] && c[2] === yc[2] && (c[3] || ("http:" === c[1] ? "80" : "443")) === (yc[3] || ("http:" === yc[1] ? "80" : "443")))), k.data && k.processData && "string" != typeof k.data && (k.data = m.param(k.data, k.traditional)), Mc(Hc, k, b, v), 2 === t)) return v;h = k.global, h && 0 === m.active++ && m.event.trigger("ajaxStart"), k.type = k.type.toUpperCase(), k.hasContent = !Ec.test(k.type), e = k.url, k.hasContent || (k.data && (e = k.url += (wc.test(e) ? "&" : "?") + k.data, delete k.data), k.cache === !1 && (k.url = Bc.test(e) ? e.replace(Bc, "$1_=" + vc++) : e + (wc.test(e) ? "&" : "?") + "_=" + vc++)), k.ifModified && (m.lastModified[e] && v.setRequestHeader("If-Modified-Since", m.lastModified[e]), m.etag[e] && v.setRequestHeader("If-None-Match", m.etag[e])), (k.data && k.hasContent && k.contentType !== !1 || b.contentType) && v.setRequestHeader("Content-Type", k.contentType), v.setRequestHeader("Accept", k.dataTypes[0] && k.accepts[k.dataTypes[0]] ? k.accepts[k.dataTypes[0]] + ("*" !== k.dataTypes[0] ? ", " + Jc + "; q=0.01" : "") : k.accepts["*"]);for (d in babelHelpers.sanitizeForInObject(k.headers)) v.setRequestHeader(d, k.headers[d]);if (k.beforeSend && (k.beforeSend.call(l, v, k) === !1 || 2 === t)) return v.abort();u = "abort";for (d in babelHelpers.sanitizeForInObject({ success: 1, error: 1, complete: 1 })) v[d](k[d]);if (i = Mc(Ic, k, b, v)) {
        v.readyState = 1, h && n.trigger("ajaxSend", [v, k]), k.async && k.timeout > 0 && (g = setTimeout(function () {
          v.abort("timeout");                                          // 4
        }, k.timeout));try {                                           //
          t = 1, i.send(r, x);                                         // 4
        } catch (w) {                                                  //
          if (!(2 > t)) throw w;x(-1, w);                              // 4
        }                                                              //
      ...
      return m.get(a, b, c, "json");                                   // 4
    }, getScript: function (a, b) {                                    //
      return m.get(a, void 0, b, "script");                            // 4
    } }), m.each(["get", "post"], function (a, b) {                    //
    m[b] = function (a, c, d, e) {                                     // 4
      return (m.isFunction(c) && (e = e || d, d = c, c = void 0), m.ajax({ url: a, type: b, dataType: e, data: c, success: d }));
    };                                                                 //
  }), m.each(["ajaxStart", "ajaxStop", "ajaxComplete", "ajaxError", "ajaxSuccess", "ajaxSend"], function (a, b) {
    m.fn[b] = function (a) {                                           // 4
      return this.on(b, a);                                            // 4
    };                                                                 //
  }), m._evalUrl = function (a) {                                      //
    return m.ajax({ url: a, type: "GET", dataType: "script", async: !1, global: !1, "throws": !0 });
  }, m.fn.extend({ wrapAll: function (a) {                             //
      if (m.isFunction(a)) return this.each(function (b) {             // 4
        m(this).wrapAll(a.call(this, b));                              // 4
      });if (this[0]) {                                                //
      ...
      return this.each(m.isFunction(a) ? function (b) {                // 4
        m(this).wrapInner(a.call(this, b));                            // 4
      } : function () {                                                //
        var b = m(this),                                               // 4
            c = b.contents();c.length ? c.wrapAll(a) : b.append(a);    //
      });                                                              //
    }, wrap: function (a) {                                            //
      var b = m.isFunction(a);return this.each(function (c) {          // 4
        m(this).wrapAll(b ? a.call(this, c) : a);                      // 4
      });                                                              //
    }, unwrap: function () {                                           //
      return this.parent().each(function () {                          // 4
        m.nodeName(this, "body") || m(this).replaceWith(this.childNodes);
      }).end();                                                        //
    } }), m.expr.filters.hidden = function (a) {                       //
    return a.offsetWidth <= 0 && a.offsetHeight <= 0 || !k.reliableHiddenOffsets() && "none" === (a.style && a.style.display || m.css(a, "display"));
  }, m.expr.filters.visible = function (a) {                           //
    return !m.expr.filters.hidden(a);                                  // 4
  };var Qc = /%20/g,                                                   //
      Rc = /\[\]$/,                                                    //
      Sc = /\r?\n/g,                                                   //
      Tc = /^(?:submit|button|image|reset|file)$/i,                    //
      Uc = /^(?:input|select|textarea|keygen)/i;function Vc(a, b, c, d) {
    var e;if (m.isArray(b)) m.each(b, function (b, e) {                // 4
      c || Rc.test(a) ? d(a, e) : Vc(a + "[" + ("object" == typeof e ? b : "") + "]", e, c, d);
    });else if (c || "object" !== m.type(b)) d(a, b);else for (e in babelHelpers.sanitizeForInObject(b)) Vc(a + "[" + e + "]", b[e], c, d);
    ...
    var c,                                                             // 4
      ...
      e(this.name, this.value);                                        // 4
    });else for (c in babelHelpers.sanitizeForInObject(a)) Vc(c, a[c], b, e);return d.join("&").replace(Qc, "+");
  }, m.fn.extend({ serialize: function () {                            //
      return m.param(this.serializeArray());                           // 4
    }, serializeArray: function () {                                   //
      return this.map(function () {                                    // 4
    ...
    for (var a in babelHelpers.sanitizeForInObject(Xc)) Xc[a](void 0, !0);
  }), k.cors = !!Yc && "withCredentials" in Yc, Yc = k.ajax = !!Yc, Yc && m.ajaxTransport(function (a) {
    if (!a.crossDomain || k.cors) {                                    // 4
      var b;return { send: function (c, d) {                           // 4
          var e,                                                       // 4
              f = a.xhr(),                                             //
              g = ++Wc;if ((f.open(a.type, a.url, a.async, a.username, a.password), a.xhrFields)) for (e in babelHelpers.sanitizeForInObject(a.xhrFields)) f[e] = a.xhrFields[e];a.mimeType && f.overrideMimeType && f.overrideMimeType(a.mimeType), a.crossDomain || c["X-Requested-With"] || (c["X-Requested-With"] = "XMLHttpRequest");for (e in babelHelpers.sanitizeForInObject(c)) void 0 !== c[e] && f.setRequestHeader(e, c[e] + "");f.send(a.hasContent && a.data || null), b = function (c, e) {
    ...
    try {                                                              // 4
      return new a.XMLHttpRequest();                                   // 4
    } catch (b) {}                                                     //
  }function $c() {                                                     //
    try {                                                              // 4
      return new a.ActiveXObject("Microsoft.XMLHTTP");                 // 4
    } catch (b) {}                                                     //
    ...
    var e,                                                             // 4
      ...
      return (g || m.error(e + " was not called"), g[0]);              // 4
    ...
    if ("string" != typeof a && bd) return bd.apply(this, arguments);var d,
      ...
      g.each(c, e || [a.responseText, b, a]);                          // 4
    }), this);                                                         //
  }, m.expr.filters.animated = function (a) {                          //
    return m.grep(m.timers, function (b) {                             // 4
      return a === b.elem;                                             // 4
    }).length;                                                         //
    ...
    var c = /Y/.test(b);m.fn[a] = function (d) {                       // 4
      return V(this, function (a, d, e) {                              // 4
    ...
    m.cssHooks[b] = Lb(k.pixelPosition, function (a, c) {              // 4
      return c ? (c = Jb(a, b), Hb.test(c) ? m(a).position()[b] + "px" : c) : void 0;
    });                                                                //
  }), m.each({ Height: "height", Width: "width" }, function (a, b) {   //
    m.each({ padding: "inner" + a, content: b, "": "outer" + a }, function (c, d) {
      m.fn[d] = function (d, e) {                                      // 4
        var f = arguments.length && (c || "boolean" != typeof d),      // 4
