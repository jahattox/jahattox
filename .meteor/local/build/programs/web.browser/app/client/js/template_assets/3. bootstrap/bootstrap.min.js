...
/////////////////////////////////////////////////////////////////////////
//                                                                     //
// client/js/template_assets/3. bootstrap/bootstrap.min.js             //
//                                                                     //
/////////////////////////////////////////////////////////////////////////
                                                                       //
/*!                                                                    //
...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery");+(function (a) {
  ...
  "use strict";function b() {                                          // 6
    var a = document.createElement("bootstrap"),                       // 6
        b = { WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "oTransitionEnd otransitionend", transition: "transitionend" };for (var c in babelHelpers.sanitizeForInObject(b)) if (void 0 !== a.style[c]) return { end: b[c] };return !1;
  }a.fn.emulateTransitionEnd = function (b) {                          //
    var c = !1,                                                        // 6
        d = this;a(this).one("bsTransitionEnd", function () {          //
      c = !0;                                                          // 6
    });var e = function () {                                           //
      c || a(d).trigger(a.support.transition.end);                     // 6
  ...
  "use strict";function b(b) {                                         // 6
    return this.each(function () {                                     // 6
      var c = a(this),                                                 // 6
          e = c.data("bs.alert");e || c.data("bs.alert", e = new d(this)), "string" == typeof b && e[b].call(c);
    });                                                                //
  }var c = '[data-dismiss="alert"]',                                   //
      d = function (b) {                                               //
    a(b).on("click", c, this.close);                                   // 6
  };d.VERSION = "3.3.5", d.TRANSITION_DURATION = 150, d.prototype.close = function (b) {
    function c() {                                                     // 6
      g.detach().trigger("closed.bs.alert").remove();                  // 6
    }var e = a(this),                                                  //
        f = e.attr("data-target");f || (f = e.attr("href"), f = f && f.replace(/.*(?=#[^\s]*$)/, ""));var g = a(f);b && b.preventDefault(), g.length || (g = e.closest(".alert")), g.trigger(b = a.Event("close.bs.alert")), b.isDefaultPrevented() || (g.removeClass("in"), a.support.transition && g.hasClass("fade") ? g.one("bsTransitionEnd", c).emulateTransitionEnd(d.TRANSITION_DURATION) : c());
  };var e = a.fn.alert;a.fn.alert = b, a.fn.alert.Constructor = d, a.fn.alert.noConflict = function () {
    return (a.fn.alert = e, this);                                     // 6
  ...
  "use strict";function b(b) {                                         // 6
    ...
    if (!/input|textarea/i.test(a.target.tagName)) {                   // 6
      switch (a.which) {case 37:                                       // 6
          this.prev();break;case 39:                                   // 6
          this.next();break;default:                                   // 6
          return;}a.preventDefault();                                  // 6
    }                                                                  //
    ...
    return this.sliding ? void 0 : this.slide("next");                 // 6
  }, c.prototype.prev = function () {                                  //
    return this.sliding ? void 0 : this.slide("prev");                 // 6
  }, c.prototype.slide = function (b, d) {                             //
    var e = this.$element.find(".item.active"),                        // 6
      ...
      if ((this.sliding = !0, g && this.pause(), this.$indicators.length)) {
        ...
        f.removeClass([b, h].join(" ")).addClass("active"), e.removeClass(["active", h].join(" ")), i.sliding = !1, setTimeout(function () {
          i.$element.trigger(m);                                       // 6
        }, 0);                                                         //
      }).emulateTransitionEnd(c.TRANSITION_DURATION)) : (e.removeClass("active"), f.addClass("active"), this.sliding = !1, this.$element.trigger(m)), g && this.cycle(), this);
    }                                                                  //
  };var d = a.fn.carousel;a.fn.carousel = b, a.fn.carousel.Constructor = c, a.fn.carousel.noConflict = function () {
    return (a.fn.carousel = d, this);                                  // 6
  };var e = function (c) {                                             //
    var d,                                                             // 6
        e = a(this),                                                   //
        f = a(e.attr("data-target") || (d = e.attr("href")) && d.replace(/.*(?=#[^\s]+$)/, ""));if (f.hasClass("carousel")) {
      var g = a.extend({}, f.data(), e.data()),                        // 6
          h = e.attr("data-slide-to");h && (g.interval = !1), b.call(f, g), h && f.data("bs.carousel").to(h), c.preventDefault();
    }                                                                  //
  };a(document).on("click.bs.carousel.data-api", "[data-slide]", e).on("click.bs.carousel.data-api", "[data-slide-to]", e), a(window).on("load", function () {
    a('[data-ride="carousel"]').each(function () {                     // 6
      var c = a(this);b.call(c, c.data());                             // 6
    });                                                                //
  });                                                                  //
})(jQuery), +(function (a) {                                           //
  "use strict";function b(b) {                                         // 6
    ...
    if (!this.transitioning && !this.$element.hasClass("in")) {        // 6
      var b,                                                           // 6
    ...
    this[this.$element.hasClass("in") ? "hide" : "show"]();            // 6
  }, d.prototype.getParent = function () {                             //
    return a(this.options.parent).find('[data-toggle="collapse"][data-parent="' + this.options.parent + '"]').each(a.proxy(function (c, d) {
      var e = a(d);this.addAriaAndCollapsedClass(b(e), e);             // 6
    }, this)).end();                                                   //
  }, d.prototype.addAriaAndCollapsedClass = function (a, b) {          //
    var c = a.hasClass("in");a.attr("aria-expanded", c), b.toggleClass("collapsed", !c).attr("aria-expanded", c);
  };var e = a.fn.collapse;a.fn.collapse = c, a.fn.collapse.Constructor = d, a.fn.collapse.noConflict = function () {
    return (a.fn.collapse = e, this);                                  // 6
  ...
  "use strict";function b(b) {                                         // 6
    ...
    c && 3 === c.which || (a(e).remove(), a(f).each(function () {      // 6
      var d = a(this),                                                 // 6
          e = b(d),                                                    //
    ...
    return this.each(function () {                                     // 6
      ...
      g = function (b) {                                               //
    a(b).on("click.bs.dropdown", this.toggle);                         // 6
  };g.VERSION = "3.3.5", g.prototype.toggle = function (d) {           //
    var e = a(this);if (!e.is(".disabled, :disabled")) {               // 6
      var f = b(e),                                                    // 6
    ...
    return (a.fn.dropdown = h, this);                                  // 6
  }, a(document).on("click.bs.dropdown.data-api", c).on("click.bs.dropdown.data-api", ".dropdown form", function (a) {
    a.stopPropagation();                                               // 6
  }).on("click.bs.dropdown.data-api", f, g.prototype.toggle).on("keydown.bs.dropdown.data-api", f, g.prototype.keydown).on("keydown.bs.dropdown.data-api", ".dropdown-menu", g.prototype.keydown);
})(jQuery), +(function (a) {                                           //
  "use strict";function b(b, d) {                                      // 6
    return this.each(function () {                                     // 6
      var e = a(this),                                                 // 6
          f = e.data("bs.modal"),                                      //
    ...
    this.options = c, this.$body = a(document.body), this.$element = a(b), this.$dialog = this.$element.find(".modal-dialog"), this.$backdrop = null, this.isShown = null, this.originalBodyPad = null, this.scrollbarWidth = 0, this.ignoreBackdropClick = !1, this.options.remote && this.$element.find(".modal-content").load(this.options.remote, a.proxy(function () {
      this.$element.trigger("loaded.bs.modal");                        // 6
    }, this));                                                         //
    ...
    return this.isShown ? this.hide() : this.show(a);                  // 6
  }, c.prototype.show = function (b) {                                 //
    var d = this,                                                      // 6
        e = a.Event("show.bs.modal", { relatedTarget: b });this.$element.trigger(e), this.isShown || e.isDefaultPrevented() || (this.isShown = !0, this.checkScrollbar(), this.setScrollbar(), this.$body.addClass("modal-open"), this.escape(), this.resize(), this.$element.on("click.dismiss.bs.modal", '[data-dismiss="modal"]', a.proxy(this.hide, this)), this.$dialog.on("mousedown.dismiss.bs.modal", function () {
      d.$element.one("mouseup.dismiss.bs.modal", function (b) {        // 6
        a(b.target).is(d.$element) && (d.ignoreBackdropClick = !0);    // 6
      });                                                              //
    }), this.backdrop(function () {                                    //
      var e = a.support.transition && d.$element.hasClass("fade");d.$element.parent().length || d.$element.appendTo(d.$body), d.$element.show().scrollTop(0), d.adjustDialog(), e && d.$element[0].offsetWidth, d.$element.addClass("in"), d.enforceFocus();var f = a.Event("shown.bs.modal", { relatedTarget: b });e ? d.$dialog.one("bsTransitionEnd", function () {
        d.$element.trigger("focus").trigger(f);                        // 6
    ...
    this.isShown && this.options.keyboard ? this.$element.on("keydown.dismiss.bs.modal", a.proxy(function (a) {
      27 == a.which && this.hide();                                    // 6
    }, this)) : this.isShown || this.$element.off("keydown.dismiss.bs.modal");
  }, c.prototype.resize = function () {                                //
    this.isShown ? a(window).on("resize.bs.modal", a.proxy(this.handleUpdate, this)) : a(window).off("resize.bs.modal");
  }, c.prototype.hideModal = function () {                             //
    var a = this;this.$element.hide(), this.backdrop(function () {     // 6
      a.$body.removeClass("modal-open"), a.resetAdjustments(), a.resetScrollbar(), a.$element.trigger("hidden.bs.modal");
    });                                                                //
  }, c.prototype.removeBackdrop = function () {                        //
    this.$backdrop && this.$backdrop.remove(), this.$backdrop = null;  // 6
    ...
    var d = this,                                                      // 6
      ...
      this.$backdrop.removeClass("in");var g = function () {           // 6
        d.removeBackdrop(), b && b();                                  // 6
    ...
    this.$element.css({ paddingLeft: "", paddingRight: "" });          // 6
  }, c.prototype.checkScrollbar = function () {                        //
    var a = window.innerWidth;if (!a) {                                // 6
      var b = document.documentElement.getBoundingClientRect();a = b.right - Math.abs(b.left);
    }this.bodyIsOverflowing = document.body.clientWidth < a, this.scrollbarWidth = this.measureScrollbar();
  }, c.prototype.setScrollbar = function () {                          //
    var a = parseInt(this.$body.css("padding-right") || 0, 10);this.originalBodyPad = document.body.style.paddingRight || "", this.bodyIsOverflowing && this.$body.css("padding-right", a + this.scrollbarWidth);
  }, c.prototype.resetScrollbar = function () {                        //
    this.$body.css("padding-right", this.originalBodyPad);             // 6
  }, c.prototype.measureScrollbar = function () {                      //
    var a = document.createElement("div");a.className = "modal-scrollbar-measure", this.$body.append(a);var b = a.offsetWidth - a.clientWidth;return (this.$body[0].removeChild(a), b);
  };var d = a.fn.modal;a.fn.modal = b, a.fn.modal.Constructor = c, a.fn.modal.noConflict = function () {
    return (a.fn.modal = d, this);                                     // 6
    ...
    var d = a(this),                                                   // 6
      ...
      a.isDefaultPrevented() || f.one("hidden.bs.modal", function () {
        d.is(":visible") && d.trigger("focus");                        // 6
      });                                                              //
    }), b.call(f, g, this);                                            //
  });                                                                  //
})(jQuery), +(function (a) {                                           //
  "use strict";function b(b) {                                         // 6
    ...
    if ((this.enabled = !0, this.type = b, this.$element = a(c), this.options = this.getOptions(d), this.$viewport = this.options.viewport && a(a.isFunction(this.options.viewport) ? this.options.viewport.call(this, this.$element) : this.options.viewport.selector || this.options.viewport), this.inState = { click: !1, hover: !1, focus: !1 }, this.$element[0] instanceof document.constructor && !this.options.selector)) throw new Error("`selector` option must be specified when initializing " + this.type + " on the window.document object!");for (var e = this.options.trigger.split(" "), f = e.length; f--;) {
      var g = e[f];if ("click" == g) this.$element.on("click." + this.type, this.options.selector, a.proxy(this.toggle, this));else if ("manual" != g) {
        var h = "hover" == g ? "mouseenter" : "focusin",               // 6
    ...
    var c = b instanceof this.constructor ? b : a(b.currentTarget).data("bs." + this.type);return (c || (c = new this.constructor(b.currentTarget, this.getDelegateOptions()), a(b.currentTarget).data("bs." + this.type, c)), b instanceof a.Event && (c.inState["focusin" == b.type ? "focus" : "hover"] = !0), c.tip().hasClass("in") || "in" == c.hoverState ? void (c.hoverState = "in") : (clearTimeout(c.timeout), c.hoverState = "in", c.options.delay && c.options.delay.show ? void (c.timeout = setTimeout(function () {
      "in" == c.hoverState && c.show();                                // 6
    }, c.options.delay.show)) : c.show()));                            //
  }, c.prototype.isInStateTrue = function () {                         //
    for (var a in babelHelpers.sanitizeForInObject(this.inState)) if (this.inState[a]) return !0;return !1;
    ...
    var d = this.tip(),                                                // 6
        ...
        d.css({ top: Math.round(a.top), left: Math.round(a.left) });   // 6
    ...
    this.enabled = !this.enabled;                                      // 6
  }, c.prototype.toggle = function (b) {                               //
    var c = this;b && (c = a(b.currentTarget).data("bs." + this.type), c || (c = new this.constructor(b.currentTarget, this.getDelegateOptions()), a(b.currentTarget).data("bs." + this.type, c))), b ? (c.inState.click = !c.inState.click, c.isInStateTrue() ? c.enter(c) : c.leave(c)) : c.tip().hasClass("in") ? c.leave(c) : c.enter(c);
  }, c.prototype.destroy = function () {                               //
    var a = this;clearTimeout(this.timeout), this.hide(function () {   // 6
      a.$element.off("." + a.type).removeData("bs." + a.type), a.$tip && a.$tip.detach(), a.$tip = null, a.$arrow = null, a.$viewport = null;
    });                                                                //
  };var d = a.fn.tooltip;a.fn.tooltip = b, a.fn.tooltip.Constructor = c, a.fn.tooltip.noConflict = function () {
    return (a.fn.tooltip = d, this);                                   // 6
  };                                                                   //
})(jQuery), +(function (a) {                                           //
  "use strict";function b(b) {                                         // 6
    return this.each(function () {                                     // 6
    ...
    return this.getTitle() || this.getContent();                       // 6
  }, c.prototype.getContent = function () {                            //
    var a = this.$element,                                             // 6
        b = this.options;return a.attr("data-content") || ("function" == typeof b.content ? b.content.call(a[0]) : b.content);
  }, c.prototype.arrow = function () {                                 //
    return this.$arrow = this.$arrow || this.tip().find(".arrow");     // 6
  };var d = a.fn.popover;a.fn.popover = b, a.fn.popover.Constructor = c, a.fn.popover.noConflict = function () {
    return (a.fn.popover = d, this);                                   // 6
  };                                                                   //
})(jQuery), +(function (a) {                                           //
  "use strict";function b(c, d) {                                      // 6
    ...
    var b = this,                                                      // 6
      ...
      b.offsets.push(this[0]), b.targets.push(this[1]);                // 6
    });                                                                //
    ...
    return (a.fn.scrollspy = d, this);                                 // 7
  }, a(window).on("load.bs.scrollspy.data-api", function () {          //
    a('[data-spy="scroll"]').each(function () {                        // 7
      var b = a(this);c.call(b, b.data());                             // 7
    });                                                                //
  });                                                                  //
})(jQuery), +(function (a) {                                           //
  "use strict";function b(b) {                                         // 7
    return this.each(function () {                                     // 7
      var d = a(this),                                                 // 7
    ...
    var b = this.element,                                              // 7
        c = b.closest("ul:not(.dropdown-menu)"),                       //
        d = b.data("target");if ((d || (d = b.attr("href"), d = d && d.replace(/.*(?=#[^\s]*$)/, "")), !b.parent("li").hasClass("active"))) {
      var e = c.find(".active:last a"),                                // 7
    ...
    return (a.fn.tab = d, this);                                       // 7
  };var e = function (c) {                                             //
    c.preventDefault(), b.call(a(this), "show");                       // 7
  ...
  "use strict";function b(b) {                                         // 7
    ...
    setTimeout(a.proxy(this.checkPosition, this), 1);                  // 7
  }, c.prototype.checkPosition = function () {                         //
    if (this.$element.is(":visible")) {                                // 7
      var b = this.$element.height(),                                  // 7
    ...
    return (a.fn.affix = d, this);                                     // 7
  }, a(window).on("load", function () {                                //
    a('[data-spy="affix"]').each(function () {                         // 7
      var c = a(this),                                                 // 7
