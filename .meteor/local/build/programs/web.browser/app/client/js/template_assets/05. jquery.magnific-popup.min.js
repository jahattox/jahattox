...
/////////////////////////////////////////////////////////////////////////
//                                                                     //
// client/js/template_assets/05. jquery.magnific-popup.min.js          //
//                                                                     //
/////////////////////////////////////////////////////////////////////////
                                                                       //
...
(function (e) {                                                        // 4
  var t,                                                               // 4
    ...
    e.magnificPopup.instance || (t = new w(), t.init(), e.magnificPopup.instance = t);
      ...
      S = function () {                                                //
    var e = document.createElement("p").style,                         // 4
      ...
      i || (i = e(document.body));var r;if (n.isObj === !1) {          // 4
        t.items = n.items.toArray(), t.index = 0;var s,                // 4
            l = n.items;for (r = 0; l.length > r; r++) if ((s = l[r], s.parsed && (s = s.el[0]), s === n.el[0])) {
          t.index = r;break;                                           // 4
        }                                                              //
        ...
        t._checkIfClose(e.target) && t.close();                        // 4
        ...
        n.close_replaceWith = E(i.type);                               // 4
        ...
        var g = t._getScrollbarSize();g && (m.marginRight = g);        // 4
      ...
      var i = function (i) {                                           // 4
        i.mfpEl = this, t._openClick(i, e, n);                         // 4
      ...
      if (t.preloader) {                                               // 4
        n !== e && t.container.removeClass("mfp-s-" + n), i || "loading" !== e || (i = t.st.tLoading);var o = { status: e, text: i };T("UpdateStatus", o), e = o.status, i = o.text, t.preloader.html(i), t.preloader.find("a").on("click", function (e) {
          e.stopImmediatePropagation();                                // 4
        }), t.container.addClass("mfp-s-" + e), n = e;                 //
      }                                                                //
    }, _checkIfClose: function (n) {                                   //
      if (!e(n).hasClass(y)) {                                         // 4
        var i = t.st.closeOnContentClick,                              // 4
      ...
      t.bgOverlay.addClass(e), t.wrap.addClass(e);                     // 4
    }, _removeClassFromMFP: function (e) {                             //
      this.bgOverlay.removeClass(e), t.wrap.removeClass(e);            // 4
      ...
      var o;i.data && (n = e.extend(i.data, n)), T(p, [t, n, i]), e.each(n, function (e, n) {
        if (void 0 === n || n === !1) return !0;if ((o = e.split("_"), o.length > 1)) {
          var i = t.find(h + "-" + o[0]);if (i.length > 0) {           // 4
    ...
    _();var i = e(this);if ("string" == typeof n) if ("open" === n) {  // 4
      var o,                                                           // 4
    ...
    L(), t.req && t.req.abort();                                       // 4
        ...
        F && i.addClass(F), t.updateStatus("loading");var o = e.extend({ url: n.src, success: function (i, o, r) {
    ...
    if (n.data && void 0 !== n.data.title) return n.data.title;var i = t.st.image.titleSrc;if (i) {
      if (e.isFunction(i)) return i.call(t, n);if (n.el) return n.el.attr(i) || "";
        ...
        var e = t.st.image,                                            // 4
          ...
          e.cursor && i.removeClass(e.cursor), I.off("resize" + h);    // 4
        ...
        var n = 0,                                                     // 4
            i = e.img[0],                                              //
            o = function (r) {                                         //
          j && clearInterval(j), j = setInterval(function () {         // 4
    ...
    return (void 0 === W && (W = void 0 !== document.createElement("p").style.MozTransform), W);
        ...
        return e.is("img") ? e : e.find("img");                        // 4
        ...
        var e,                                                         // 4
          ...
          var o,                                                       // 4
            ...
            var t = e.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image"),
              ...
              d = function () {                                        //
            t.content.css("visibility", "visible");                    // 4
            ...
            if (t._allowZoom()) {                                      // 4
              if ((clearTimeout(o), t.content.css("visibility", "hidden"), e = t._getItemToZoom(), !e)) return (d(), void 0);r = s(e), r.css(t._getOffset()), t.wrap.append(r), o = setTimeout(function () {
                r.css(t._getOffset(!0)), o = setTimeout(function () {  // 4
                  d(), setTimeout(function () {                        // 4
            ...
            if (t._allowZoom()) {                                      // 4
              if ((clearTimeout(o), t.st.removalDelay = a, !e)) {      // 4
                if ((e = t._getItemToZoom(), !e)) return;r = s(e);     // 4
              }r.css(t._getOffset(!0)), t.wrap.append(r), t.content.css("visibility", "hidden"), setTimeout(function () {
                r.css(t._getOffset());                                 // 4
              }, 16);                                                  //
            }                                                          //
          }), x(l + i, function () {                                   //
            t._allowZoom() && (d(), r && r.remove(), e = null);        // 4
          });                                                          //
        }                                                              //
      }, _allowZoom: function () {                                     //
        return "image" === t.currItem.type;                            // 4
      }, _getItemToZoom: function () {                                 //
        return t.currItem.hasSize ? t.currItem.img : !1;               // 4
    ...
    if (t.currTemplate[Z]) {                                           // 4
      var n = t.currTemplate[Z].find("iframe");n.length && (e || (n[0].src = q), t.isIE8 && n.css("display", e ? "block" : "none"));
        ...
        t.types.push(Z), x("BeforeChange", function (e, t, n) {        // 4
          t !== n && (t === Z ? D() : n === Z && D(!0));               // 4
        }), x(l + "." + Z, function () {                               //
          D();                                                         // 4
        });                                                            //
    ...
    var n = t.items.length;return e > n - 1 ? e - n : 0 > e ? n + e : e;
      ...
      Y = function (e, t, n) {                                         //
    return e.replace(/%curr%/gi, t + 1).replace(/%total%/gi, n);       // 4
        ...
        var n = t.st.gallery,                                          // 4
          ...
          if (t.items.length > 1 && n.arrows && !t.arrowLeft) {        // 4
            var i = n.arrowMarkup,                                     // 4
          ...
          t._preloadTimeout && clearTimeout(t._preloadTimeout), t._preloadTimeout = setTimeout(function () {
            t.preloadNearbyImages(), t._preloadTimeout = null;         // 4
          }, 16);                                                      //
        }), x(l + i, function () {                                     //
        ...
        t.direction = e >= t.index, t.index = e, t.updateItemHTML();   // 4
      }, preloadNearbyImages: function () {                            //
        var e,                                                         // 4
            n = t.st.gallery.preload,                                  //
            i = Math.min(n[0], t.items.length),                        //
            o = Math.min(n[1], t.items.length);for (e = 1; (t.direction ? o : i) >= e; e++) t._preloadItem(t.index + e);for (e = 1; (t.direction ? i : o) >= e; e++) t._preloadItem(t.index - e);
      }, _preloadItem: function (n) {                                  //
        if ((n = K(n), !t.items[n].preloaded)) {                       // 4
          var i = t.items[n];i.parsed || (i = t.parseEl(n)), T("LazyLoad", i), "image" === i.type && (i.img = e('<img class="mfp-img" />').on("load.mfploader", function () {
            ...
            i.hasSize = !0, i.loadError = !0, T("LazyLoadError", i);   // 4
          }).attr("src", i.src)), i.preloaded = !0;                    //
        }                                                              //
      } } });var U = "retina";e.magnificPopup.registerModule(U, { options: { replaceSrc: function (e) {
        return e.src.replace(/\.\w+$/, function (e) {                  // 4
          return "@2x" + e;                                            // 4
        });                                                            //
    ...
    var t = 1e3,                                                       // 4
        ...
        i = function () {                                              //
      I.off("touchmove" + r + " touchend" + r);                        // 4
    },                                                                 //
        o = "mfpFastClick",                                            //
        r = "." + o;e.fn.mfpFastClick = function (o) {                 //
      return e(this).each(function () {                                // 4
        var a,                                                         // 4
            s = e(this);if (n) {                                       //
          var l, c, d, u, p, f;s.on("touchstart" + r, function (e) {   // 4
