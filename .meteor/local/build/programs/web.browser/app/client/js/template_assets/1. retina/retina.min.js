...
/////////////////////////////////////////////////////////////////////////
//                                                                     //
// client/js/template_assets/1. retina/retina.min.js                   //
//                                                                     //
/////////////////////////////////////////////////////////////////////////
                                                                       //
/*!                                                                    //
 ...
 */                                                                    //
!(function () {                                                        // 10
  function a() {}function b(a) {                                       // 10
    return f.retinaImageSuffix + a;                                    // 10
  }function c(a, c) {                                                  //
    if ((this.path = a || "", "undefined" != typeof c && null !== c)) this.at_2x_path = c, this.perform_check = !1;else {
      if (void 0 !== document.createElement) {                         // 10
    ...
    null === a && (a = {});for (var b in babelHelpers.sanitizeForInObject(a)) a.hasOwnProperty(b) && (f[b] = a[b]);
  }, a.init = function (a) {                                           //
