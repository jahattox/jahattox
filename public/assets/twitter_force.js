var width = 960,
    ...
    boxSide = 20,
		...
		loading = $('.loading-temporary');

$('.d3js-twitter-force-graph-form').on('submit', function(e) {
	e.preventDefault();
	$('svg').remove();
	loading.show();
	var term = $('#tweet-term').val();
...
generateGraph = function(data, term) {
...
/*
	tweetLangs.forEach(function(d) {
		var className = '.' + d,
    			el = d3.selectAll(className);
